...
public class TestLibraryBooksTest {
    TestLibraryBooks testLibraryBooks;
    ...
    public void should_get_the_book_when_user_input_the_existing_book() {
        ...
        testLibraryBooks = new TestLibraryBooks(books);

        Optional<Book> exceptedBook = testLibraryBooks.getItemInfoByItemNo("1");
    ...
    public void should_return_the_book_when_the_book_is_exist_and_is_not_in_library() {
        ...
        boolean isReturn1 = testLibraryBooks.returnItemByItemNo("1");
        boolean isReturn2 = testLibraryBooks.returnItemByItemNo("2");
        boolean isReturn3 = testLibraryBooks.returnItemByItemNo("4");
